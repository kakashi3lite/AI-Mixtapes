...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/OpenAIKit/OpenAIKit.git", from: "1.0.0"),
        .package(url: "https://github.com/GPTKit/GPTKit.git", from: "1.0.0"),
    ],
    targets: [
        // Main App Target
        .executableTarget(
            ...
            dependencies: [
                ...
                .product(name: "GPTKit", package: "GPTKit"),
